...
def create_visual_file(file_bath_index, input_x, visual_list: list, seq_len):
    f = open(os.path.join('attention_html',str(file_bath_index)+'_attention.html'), 'w')
